...
#define MARRY_HIGHT_SPEED       1   // marry 用的高速
// #define BED_TEMP_COMP             // 热床温度补偿
//===========================================================================
//============================= Getting Started =============================
//===========================================================================
...
//  #define MACHINE_TYPE      "CR-200B"
#if ENABLED(MARRY_HIGHT_SPEED)
  #define FIRMWARE_VERSION  "1.0.7T3-1"
#else
  #define FIRMWARE_VERSION  "1.0.7T3"
#endif
...
#define PID_K1 0.95      // Smoothing factor within any PID loop  rock_20220914
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 105.62
  #define DEFAULT_bedKi 20.96
  #define DEFAULT_bedKd 354.87
...
#define X_HOME_DIR 1
#define Y_HOME_DIR 1
// #define Z_HOME_DIR 1//-1  rock_20220730
#define Z_HOME_DIR -1//-1  rock_20220730
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (10*60) }  //{ (50*60), (50*60), (4*60) }  //rock_20220328
...
// 开启BLtouch + 下限位功能
// #if ENABLED(BLTOUCH) && Z_HOME_DIR > 0
