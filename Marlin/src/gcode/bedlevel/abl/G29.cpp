...
void CorrectZ_values(bed_mesh_t z_values)//(float (*z_values)[5])
{
  float tempOne0_0=0.0;
  float tempTwo0_0=0.0;
  float tempThree0_0=0.0;

  float tempOne0_1=0.0;
  float tempTwo0_1=0.0;
  float tempThree0_1=0.0;  

  float tempOne1_0=0.0;
  float tempTwo1_0=0.0;
  float tempThree1_0=0.0;    

  float tempOne1_1=0.0;
  float tempTwo1_1=0.0;
  float tempThree1_1=0.0;   

  float tempOne0_4=0.0;
  float tempTwo0_4=0.0;
  float tempThree0_4=0.0;  

  float tempOne0_3=0.0;
  float tempTwo0_3=0.0;
  float tempThree0_3=0.0; 

  float tempOne1_4=0.0;
  float tempTwo1_4=0.0;
  float tempThree1_4=0.0; 

  float tempOne1_3=0.0;
  float tempTwo1_3=0.0;
  float tempThree1_3=0.0;   

  float tempOne4_4=0.0;
  float tempTwo4_4=0.0;
  float tempThree4_4=0.0;  

  float tempOne3_4=0.0;
  float tempTwo3_4=0.0;
  float tempThree3_4=0.0; 

  float tempOne4_3=0.0;
  float tempTwo4_3=0.0;
  float tempThree4_3=0.0; 

  float tempOne3_3=0.0;
  float tempTwo3_3=0.0;
  float tempThree3_3=0.0; 

  float tempOne4_0=0.0;
  float tempTwo4_0=0.0;
  float tempThree4_0=0.0;  

  float tempOne3_0=0.0;
  float tempTwo3_0=0.0;
  float tempThree3_0=0.0;     

  float tempOne4_1=0.0;
  float tempTwo4_1=0.0;
  float tempThree4_1=0.0;  

  float tempOne3_1=0.0;
  float tempTwo3_1=0.0;
  float tempThree3_1=0.0;               

  //左下角
  tempOne0_0=-((z_values[0][4]-z_values[0][3])+(z_values[0][3]-z_values[0][2])+(z_values[0][2]-z_values[0][1]))/3.0+z_values[0][1];
  tempTwo0_0=-((z_values[4][0]-z_values[3][0])+(z_values[3][0]-z_values[2][0])+(z_values[2][0]-z_values[1][0]))/3.0+z_values[1][0];
  tempThree0_0=-((z_values[4][4]-z_values[3][3])+(z_values[3][3]-z_values[2][2])+(z_values[2][2]-z_values[1][1]))/3.0+z_values[1][1];


  tempOne0_1=-((z_values[0][4]-z_values[0][3])+(z_values[0][3]-z_values[0][2]))/2.0+z_values[0][2];
  tempTwo0_1=-((z_values[4][1]-z_values[3][1])+(z_values[3][1]-z_values[2][1])+(z_values[2][1]-z_values[1][1]))/3.0+z_values[1][1];
  tempThree0_1=-((z_values[3][4]-z_values[2][3])+(z_values[2][3]-z_values[1][2]))/2.0+z_values[1][2];


  tempOne1_0=-((z_values[1][4]-z_values[1][3])+(z_values[1][3]-z_values[1][2])+(z_values[1][2]-z_values[1][1]))/3.0+z_values[1][1];
  tempTwo1_0=-((z_values[4][0]-z_values[3][0])+(z_values[3][0]-z_values[2][0]))/2.0+z_values[2][0];
  tempThree1_0=-((z_values[4][3]-z_values[3][2])+(z_values[3][2]-z_values[2][1]))/2.0+z_values[2][1];


  tempOne1_1=-((z_values[1][4]-z_values[1][3])+(z_values[1][3]-z_values[1][2]))/2.0+z_values[1][2];
  tempTwo1_1=-((z_values[4][1]-z_values[3][1])+(z_values[3][1]-z_values[2][1]))/2.0+z_values[2][1];
  tempThree1_1=-((z_values[4][4]-z_values[3][3])+(z_values[3][3]-z_values[2][2]))/2.0+z_values[2][2];

  //左上角
  tempOne0_4=-((z_values[4][4]-z_values[3][4])+(z_values[3][4]-z_values[2][4])+(z_values[2][4]-z_values[1][4]))/3.0+z_values[1][4];
  tempTwo0_4=-((z_values[0][0]-z_values[0][1])+(z_values[0][1]-z_values[0][2])+(z_values[0][2]-z_values[0][3]))/3.0+z_values[0][3];
  tempThree0_4=-((z_values[4][0]-z_values[3][1])+(z_values[3][1]-z_values[2][2])+(z_values[2][2]-z_values[1][3]))/3.0+z_values[1][3];

  tempOne0_3=-((z_values[4][3]-z_values[3][3])+(z_values[3][3]-z_values[2][3])+(z_values[2][3]-z_values[1][3]))/3.0+z_values[1][3];
  tempTwo0_3=-((z_values[0][0]-z_values[0][1])+(z_values[0][1]-z_values[0][2]))/2.0+z_values[0][2];
  tempThree0_3=-((z_values[3][0]-z_values[2][1])+(z_values[2][1]-z_values[1][2]))/2.0+z_values[1][2];

  tempOne1_4=-((z_values[1][0]-z_values[1][1])+(z_values[1][1]-z_values[1][2])+(z_values[1][2]-z_values[1][3]))/3.0+z_values[1][3];
  tempTwo1_4=-((z_values[4][4]-z_values[3][4])+(z_values[3][4]-z_values[2][4]))/2.0+z_values[2][4];
  tempThree1_4=-((z_values[4][1]-z_values[3][2])+(z_values[3][2]-z_values[2][3]))/2.0+z_values[2][3];  

  tempOne1_3=-((z_values[4][3]-z_values[3][3])+(z_values[3][3]-z_values[2][3]))/2.0+z_values[2][3];
  tempTwo1_3=-((z_values[1][0]-z_values[1][1])+(z_values[1][1]-z_values[1][2]))/2.0+z_values[1][2];
  tempThree1_3=-((z_values[4][0]-z_values[3][1])+(z_values[3][1]-z_values[2][2]))/2.0+z_values[2][2];

  //右上角
  tempOne4_4=-((z_values[0][4]-z_values[1][4])+(z_values[1][4]-z_values[2][4])+(z_values[2][4]-z_values[3][4]))/3.0+z_values[3][4];
  tempTwo4_4=-((z_values[4][0]-z_values[4][1])+(z_values[4][1]-z_values[4][2])+(z_values[4][2]-z_values[4][3]))/3.0+z_values[4][3];
  tempThree4_4=-((z_values[0][0]-z_values[1][1])+(z_values[1][1]-z_values[2][2])+(z_values[2][2]-z_values[3][3]))/3.0+z_values[3][3];

  tempOne3_4=-((z_values[3][0]-z_values[3][1])+(z_values[3][1]-z_values[3][2])+(z_values[3][2]-z_values[3][3]))/3.0+z_values[3][3];
  tempTwo3_4=-((z_values[0][4]-z_values[1][4])+(z_values[1][4]-z_values[2][4]))/2.0+z_values[2][4];
  tempThree3_4=-((z_values[0][1]-z_values[1][2])+(z_values[1][2]-z_values[2][3]))/2.0+z_values[2][3];

  tempOne4_3=-((z_values[0][3]-z_values[1][3])+(z_values[1][3]-z_values[2][3])+(z_values[2][3]-z_values[3][3]))/3.0+z_values[3][3];
  tempTwo4_3=-((z_values[4][0]-z_values[4][1])+(z_values[4][1]-z_values[4][2]))/2.0+z_values[4][2];
  tempThree4_3=-((z_values[1][0]-z_values[2][1])+(z_values[2][1]-z_values[3][2]))/2.0+z_values[3][2];  

  tempOne3_3=-((z_values[0][3]-z_values[1][3])+(z_values[1][3]-z_values[2][3]))/2.0+z_values[2][3];
  tempTwo3_3=-((z_values[3][0]-z_values[3][1])+(z_values[3][1]-z_values[3][2]))/2.0+z_values[3][2];
  tempThree3_3=-((z_values[0][0]-z_values[1][1])+(z_values[1][1]-z_values[2][2]))/2.0+z_values[2][2]; 

  //右下角
  tempOne4_0=-((z_values[4][4]-z_values[4][3])+(z_values[4][3]-z_values[4][2])+(z_values[4][2]-z_values[4][1]))/3.0+z_values[4][1];
  tempTwo4_0=-((z_values[0][0]-z_values[1][0])+(z_values[1][0]-z_values[2][0])+(z_values[2][0]-z_values[3][0]))/3.0+z_values[3][0];
  tempThree4_0=-((z_values[0][4]-z_values[1][3])+(z_values[1][3]-z_values[2][2])+(z_values[2][2]-z_values[3][1]))/3.0+z_values[3][1];

  tempOne3_0=-((z_values[3][4]-z_values[3][3])+(z_values[3][3]-z_values[3][2])+(z_values[3][2]-z_values[3][1]))/3.0+z_values[3][1];
  tempTwo3_0=-((z_values[0][0]-z_values[1][0])+(z_values[1][0]-z_values[2][0]))/2.0+z_values[2][0];
  tempThree3_0=-((z_values[0][3]-z_values[1][2])+(z_values[1][2]-z_values[2][1]))/2.0+z_values[2][1];

  tempOne4_1=-((z_values[0][1]-z_values[1][1])+(z_values[1][1]-z_values[2][1])+(z_values[2][1]-z_values[3][1]))/3.0+z_values[3][1];
  tempTwo4_1=-((z_values[4][4]-z_values[4][3])+(z_values[4][3]-z_values[4][2]))/2.0+z_values[4][2];
  tempThree4_1=-((z_values[1][4]-z_values[2][3])+(z_values[2][3]-z_values[3][2]))/2.0+z_values[3][2];  

  tempOne3_1=-((z_values[3][4]-z_values[3][3])+(z_values[3][3]-z_values[3][2]))/2.0+z_values[3][2];
  tempTwo3_1=-((z_values[0][1]-z_values[1][1])+(z_values[1][1]-z_values[2][1]))/2.0+z_values[2][1];
  tempThree3_1=-((z_values[0][4]-z_values[1][3])+(z_values[1][3]-z_values[2][2]))/2.0+z_values[2][2];    

  //计算均值
  z_values[0][0]=(tempOne0_0+tempTwo0_0+tempThree0_0)/3.0;
  z_values[0][1]=(tempOne0_1+tempTwo0_1+tempThree0_1+z_values[0][1])/4.0;  
  z_values[1][0]=(tempOne1_0+tempTwo1_0+tempThree1_0+z_values[1][0])/4.0;  
  z_values[1][1]=(tempOne1_1+tempTwo1_1+tempThree1_1+z_values[1][1])/4.0; 

  z_values[0][4]=(tempOne0_4+tempTwo0_4+tempThree0_4+z_values[0][4])/4.0;       
  z_values[0][3]=(tempOne0_3+tempTwo0_3+tempThree0_3+z_values[0][3])/4.0;  
  z_values[1][4]=(tempOne1_4+tempTwo1_4+tempThree1_4+z_values[1][4])/4.0;  
  z_values[1][3]=(tempOne1_3+tempTwo1_3+tempThree1_3+z_values[1][3])/4.0;    

  z_values[4][4]=(tempOne4_4+tempTwo4_4+tempThree4_4+z_values[4][4])/4.0;       
  z_values[3][4]=(tempOne3_4+tempTwo3_4+tempThree3_4+z_values[3][4])/4.0;  
  z_values[4][3]=(tempOne4_3+tempTwo4_3+tempThree4_3+z_values[4][3])/4.0;  
  z_values[3][3]=(tempOne3_3+tempTwo3_3+tempThree3_3+z_values[3][3])/4.0;     

  z_values[4][0]=(tempOne4_0+tempTwo4_0+tempThree4_0+z_values[4][0])/4.0;       
  z_values[3][0]=(tempOne3_0+tempTwo3_0+tempThree3_0+z_values[3][0])/4.0;  
  z_values[4][1]=(tempOne4_1+tempTwo4_1+tempThree4_1+z_values[4][1])/4.0;  
  z_values[3][1]=(tempOne3_1+tempTwo3_1+tempThree3_1+z_values[3][1])/4.0;     

  //加权计算法
  // z_values[0][0]=(tempOne0_0+tempTwo0_0+tempThree0_0)/3.0*0.4+z_values[0][0]*0.6;
  // z_values[0][1]=(tempOne0_1+tempTwo0_1+tempThree0_1)/3.0*0.4+z_values[0][1]*0.6;  
  // z_values[1][0]=(tempOne1_0+tempTwo1_0+tempThree1_0)/3.0*0.4+z_values[1][0]*0.6;  
  // z_values[1][1]=(tempOne1_1+tempTwo1_1+tempThree1_1)/3.0*0.4+z_values[1][1]*0.6;

  // z_values[0][4]=(tempOne0_4+tempTwo0_4+tempThree0_4)/3.0*0.4+z_values[0][4]*0.6;       
  // z_values[0][3]=(tempOne0_3+tempTwo0_3+tempThree0_3)/3.0*0.4+z_values[0][3]*0.6;  
  // z_values[1][4]=(tempOne1_4+tempTwo1_4+tempThree1_4)/3.0*0.4+z_values[1][4]*0.6;  
  // z_values[1][3]=(tempOne1_3+tempTwo1_3+tempThree1_3)/3.0*0.4+z_values[1][3]*0.6;   

  // z_values[4][4]=(tempOne4_4+tempTwo4_4+tempThree4_4)/3.0*0.4+z_values[4][4]*0.6;       
  // z_values[3][4]=(tempOne3_4+tempTwo3_4+tempThree3_4)/3.0*0.4+z_values[3][4]*0.6;  
  // z_values[4][3]=(tempOne4_3+tempTwo4_3+tempThree4_3)/3.0*0.4+z_values[4][3]*0.6; 
  // z_values[3][3]=(tempOne3_3+tempTwo3_3+tempThree3_3)/3.0*0.4+z_values[3][3]*0.6;     

  // z_values[4][0]=(tempOne4_0+tempTwo4_0+tempThree4_0)/3.0*0.4+z_values[4][0]*0.6;       
  // z_values[3][0]=(tempOne3_0+tempTwo3_0+tempThree3_0)/3.0*0.4+z_values[3][0]*0.6; 
  // z_values[4][1]=(tempOne4_1+tempTwo4_1+tempThree4_1)/3.0*0.4+z_values[4][1]*0.6;
  // z_values[3][1]=(tempOne3_1+tempTwo3_1+tempThree3_1)/3.0*0.4+z_values[3][1]*0.6;       
}
  ...
  if (!g29_in_progress) {
    ...
    //
      ...
      if (abl.abl_probe_index < abl.abl_points) {
        // abl.probePos.y-=NOZZLE_TO_PROBE_OFFSET_Y;
      ...
      for (PR_OUTER_VAR = 0, showcount = 0; PR_OUTER_VAR < PR_OUTER_SIZE && !isnan(abl.measured_z); PR_OUTER_VAR++) {
        ...
        for (PR_INNER_VAR = inStart; PR_INNER_VAR != inStop; pt_index++, PR_INNER_VAR += inInc) {
          ...
          if (isnan(abl.measured_z)) {
            ...
            SERIAL_ECHOLNPAIR(" abl.meshCount.x=: ", abl.meshCount.x,
                              " abl.meshCount.y=: ", abl.meshCount.y,
                              " abl.Z_offset=: ",abl.Z_offset,
                              "  z = ", z);
...
//调平数据补偿接口
    ...
    // {
    //   // z_values[3][index]+=( z_values[3][index]*0.3);
    //   // z_values[2][index]+=( z_values[2][index]*0.3);
    //   // z_values[2][index]+=( z_values[1][index]*0.3);
    //   // z_values[0][index]+=( z_values[0][index]*0.3);
    //   z_values[index][1]*=0.8;
    //   z_values[index][2]*=0.8;
    //   z_values[index][3]*=0.8;
    //   z_values[index][0]*=0.8;
    // }

  print_bilinear_leveling_grid();//打印原始数据


   CorrectZ_values(z_values);
  ...
  report_current_position();
  ...
  #if ENABLED(RTS_AVAILABLE)
    G29_flag = false;
    // G29_finished=true;  //G29已经完成 rock_20220902
    ...
    if(temphot > 0)
    {
      ...
      while ((ABS(thermalManager.degHotend(0) - thermalManager.degTargetHotend(0)) > TEMP_WINDOW) && (thermalManager.degTargetHotend(0) >= 170))
      {
        idle();
      }
    }
