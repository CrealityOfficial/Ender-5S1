...
#define DISABLE_AXIS_X() if (SHOULD_DISABLE(x)) { DISABLE_STEPPER_X(); DISABLE_STEPPER_X2(); AFTER_CHANGE(x, false); SERIAL_ECHO_MSG("DISABLE_AXIS_X set_axis_untrusted"); set_axis_untrusted(X_AXIS); }
#define  ENABLE_AXIS_Y() if (SHOULD_ENABLE(y))  {  ENABLE_STEPPER_Y();  ENABLE_STEPPER_Y2(); AFTER_CHANGE(y, true); }
#define DISABLE_AXIS_Y() if (SHOULD_DISABLE(y)) { DISABLE_STEPPER_Y(); DISABLE_STEPPER_Y2(); AFTER_CHANGE(y, false); SERIAL_ECHO_MSG("DISABLE_AXIS_Y set_axis_untrusted"); set_axis_untrusted(Y_AXIS); }
...
#define DISABLE_AXIS_Z() if (SHOULD_DISABLE(z)) { DISABLE_STEPPER_Z(); DISABLE_STEPPER_Z2(); DISABLE_STEPPER_Z3(); DISABLE_STEPPER_Z4(); AFTER_CHANGE(z, false); SERIAL_ECHO_MSG("DISABLE_AXIS_Z set_axis_untrusted"); set_axis_untrusted(Z_AXIS); Z_RESET(); }
